...
inline void* PartnerQuery(longlong theHash,...) {return NULL;}
inline void* PartnerQuery(char *theInfo, void* extraInfo=NULL) {return NULL;}
inline char* PartnerQueryString(char* theQuery, void* extraInfo=NULL) {return NULL;}
inline void PartnerQueryBytes(char* theQuery, void** thePtr, int* theSize) {}
